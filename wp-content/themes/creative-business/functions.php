...
function creative_business_enqueue_styles() {
    ...
    $query_args = array(
        'family' => 'Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i%7CSource+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i',
        'subset' => 'latin,latin-ext',
    );
    wp_enqueue_style( 'creative-business-google-fonts', add_query_arg( $query_args, "//fonts.googleapis.com/css" ), array(), null );
}
...
function creative_business_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'creative-business' ), esc_url( __( 'https://demo.raratheme.com/creative-business/', 'creative-business' ) ), esc_html__( 'Click here.', 'creative-business' ) );

    $theme_info .= '</p><p>';

    /* translators: 1: string, 2: documentation url, 3: string */
    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'creative-business' ), esc_url( 'https://docs.raratheme.com/docs/creative-business-documentation/' ), esc_html__( 'Click here.', 'creative-business' ) );
...
function creative_business_customizer_demo_content( $wp_customize ) {
    ...
    $theme_demo_content_desc .= '<span class="sticky_info_row download-link"><label class="row-element">' . __( 'Download Demo Content', 'creative-business' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/creative-business/' ) . '" target="_blank">' . __( 'Click here', 'creative-business' ) . '</a></span><br />';
...
function rara_business_footer_bottom(){ ?>
    <div class="footer-b">      
        <?php
            ...
            echo '<a href="' . esc_url( 'https://raratheme.com/' ) .'" rel="nofollow" target="_blank">' . esc_html__( 'Rara Theme', 'creative-business' ) . '</a>.';
            echo '</span>';
